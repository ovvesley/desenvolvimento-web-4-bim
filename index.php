		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Entre no <span class="title-amar">amo</span>vie.
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="script-login.php" method="POST">
					...
					<div style="margin: 20px 0px 0px 20px;">
						<span>Não Registrado ?<a href="registrar.php"> Registrar.</a> </span>
					</div>
